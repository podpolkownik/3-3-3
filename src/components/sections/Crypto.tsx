      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <section className="mb-16 text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
            New Peak at $500K and Altseason — Analysts' Predictions
            <motion.div
            ...
            >
              <ArrowUpRight className="w-6 h-6 animate-pulse inline-block" />
            </motion.div>
          </h2>
          ...
          <p className="text-lg leading-relaxed mb-4 max-w-3xl mx-auto">
            ...
            With this growth, Bitcoin is expected to reach new heights, including the $500K target from VanEck. Investors, confident in the future 
